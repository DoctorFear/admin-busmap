...
export default function DriverPage() {
  ...
  const handleReportSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Báo cáo:', reportNote);
    setReportNote('');
  };
  ...
  return (
    <div className={styles.driverContainer}>
        <div id="home" className={styles.mapSection}>
      ...
      <div id="students" className={styles.studentList}>
      ...
      <div id="alerts" className={styles.alerts}>
          <h3>Gửi cảnh báo</h3>
